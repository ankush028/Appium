...
public class Base {
    ...
    public Base()  {
        ...
        try {
            fis = new FileInputStream(
                    "/home/ankit/Myntra/src/main/java/com/bridgelabz/myntra/config/config.properties");
            property.load(fis);
    ...
    * */
    public static void initiation(){
        ...
        desiredCapabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME,property.getProperty("AUTOMATION_NAME"));
        desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_NAME,property.getProperty("PLATFORM_NAME"));
        desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, property.getProperty("PLATFORM_VERSION"));
